            ...
            <ul class="vertical-nav-menu">
                ...
                <li class="mm-active">
                    <a href="{{ url('user/dashboard') }}"
                       class="{{ Request::is('user.dashboard') ? 'mm-active' : '' }}">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('user.pay-now.index') }}"
                               class="{{ Request::is('user/pay-now') ? 'mm-active' : '' }}">
                                <i class="metismenu-icon"></i>Check Payment Status
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('user.pay-now.create') }}"
                               class="{{ Request::is('user/pay-now/create') ? 'mm-active' : '' }}">
                ...
                <li class="app-sidebar__heading">Service Widgets</li>
                <!-- Courier Widget -->
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('user.ShipForMe.index') }}"
                               class="{{ Request::is('user/ShipForMe') ? 'mm-active' : '' }}">
...
{{--                    <ul>--}}
{{--                        <li>--}}
{{--                            <a href="{{ route('user.BuyForMe.index') }}"--}}
{{--                               class="{{ Request::is('user/BuyForMe') ? 'mm-active' : '' }}">--}}
{{--                                <i class="metismenu-icon"></i>Check Buy Order Status--}}
{{--                            </a>--}}
{{--                        </li>--}}

{{--                        <li>--}}
{{--                            <a href="{{ route('user.BuyForMe.create') }}"--}}
{{--                               class="{{ Request::is('user/BuyForMe/create') ? 'mm-active' : '' }}">--}}
...
{{--                </li>--}}
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('user.profileIndex') }}"
                               class="{{ Request::is('user/profileIndex') ? 'mm-active' : '' }}">
